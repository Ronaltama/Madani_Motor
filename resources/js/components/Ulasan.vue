<template>
  <section class="py-16" style="background-color: #f7f7f7;">
    <div class="container mx-auto px-4">
      <!-- Header Section -->
      <div class="text-center mb-12">
        <h1 class="text-3xl font-bold mb-3 text-gray-900">Ulasan dari Pelanggan Kami</h1>
        <div class="w-24 h-1 bg-[#BB0102] mx-auto rounded-full"></div>
        <p class="text-gray-700 mt-4">Simak pengalaman pelanggan Madani Motor setelah bertransaksi bersama kami.</p>
      </div>
      ...
      <div class="relative max-w-6xl mx-auto px-12">
        <div class="relative pb-12">
          ...
          <button 
            ...
            class="absolute -left-4 lg:-left-12 top-1/2 -translate-y-1/2 bg-white hover:bg-[#BB0102] text-gray-800 hover:text-white rounded-full p-3 shadow-lg transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed z-10"
          >
          ...
          <button 
            ...
            class="absolute -right-4 lg:-right-12 top-1/2 -translate-y-1/2 bg-white hover:bg-[#BB0102] text-gray-800 hover:text-white rounded-full p-3 shadow-lg transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed z-10"
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div class="flex justify-center gap-2 mt-2">
          <button 
            ...
            :class="currentIndex === index - 1 ? 'bg-[#BB0102] w-8' : 'bg-gray-300 w-2'"
            class="h-2 rounded-full transition-all duration-300 hover:bg-[#BB0102]"
          ></button>
        </div>
      </div>
    </div>

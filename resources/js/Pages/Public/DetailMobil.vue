            ...
            <div v-if="car" class="max-w-7xl mx-auto px-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    @click.stop="goBack"
                                    class="absolute top-3 left-3 bg-white bg-opacity-95 hover:bg-white rounded-full p-1.5 shadow-md hover:shadow-lg transition-all duration-200 z-10 group"
                                >
                                    <svg
                                ...
                                />
                                <div
                                    class="absolute bottom-4 right-4 bg-black bg-opacity-70 text-white px-3 py-1 rounded-md text-sm"
                                >
                                    {{ currentImageIndex + 1 }}/{{
                                        carImages.length
                                    }}
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="bg-white rounded-lg shadow-md p-6 sticky top-4"
                        >
                            <div
                                class="inline-block bg-gradient-to-r from-red-100 to-pink-100 text-[#BB0102] text-xs font-semibold px-3 py-1 rounded-full mb-3"
                            >
                            ...
                            <div class="mb-4">
                                <p class="text-[#BB0102] font-bold text-3xl">
                                    Rp {{ formattedPrice }},-
                                </p>
                            </div>
                            ...
                            <div class="pt-4">
                                <div
                                    ...
                                    class="flex items-start gap-2 text-sm text-gray-600 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors"
                                >
                                    <svg
                            ...
                            <div
                                class="border-t border-gray-300 mt-4 mb-4"
                            ></div>
                            ...
                            <a
                                :href="whatsappLink"
                                target="_blank"
                                class="block w-full bg-[#1FAD4F] hover:bg-[#1a9342] text-white font-semibold py-3 px-4 rounded-lg text-center transition-colors flex items-center justify-center gap-2"
                            >
                                <svg
                                    class="w-5 h-5"
                                    fill="currentColor"
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                    <div class="mb-6">
                        <div class="flex gap-8">
                            <button
                                ...
                                class="pb-3 font-semibold transition-colors relative"
                                :class="
                                    activeTab === 'detail'
                                        ? 'text-[#BB0102]'
                    ...
                    <div v-show="activeTab === 'detail'">
                        <div class="text-center mb-6">
                            ...
                            <div
                                class="w-24 h-1 bg-[#BB0102] mx-auto rounded-full mb-2"
                            ></div>
                    ...
                    <div v-show="activeTab === 'fitur'">
                        <div class="text-center mb-6">
                            <h2 class="text-2xl font-bold mb-2">Fitur Mobil</h2>
                            <div
                                class="w-24 h-1 bg-[#BB0102] mx-auto rounded-full"
                            ></div>
                        </div>
                ...
                <div class="mb-12 mt-12">
                    <div class="mb-6">
                        <h2
                            class="text-xl font-bold inline-block relative pb-2"
                        >
                            Pilihan Mobil Lainnya
                        </h2>
                        <div
                            class="w-24 h-1 bg-[#BB0102] mt-1 rounded-full"
                        ></div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        >
                            <article
                                ...
                                :key="similarCar.id"
                                class="w-[279px] bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer overflow-hidden flex-shrink-0"
                            ...
                            >
                                ...
                                <div class="p-4">
                                    <h4
                                        class="text-base font-semibold mb-2 line-clamp-2"
                                    >
                                        {{ similarCar.name }}
                                    </h4>
                                    ...
                                    <p class="text-[#BB0102] font-bold text-lg">
                                        Rp
                                        {{
...
const whatsappLink = computed(() => {
    if (!props.car) return "#";
    const phoneNumber = "6298616498342";

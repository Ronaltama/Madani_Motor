        ...
        <section class="max-w-6xl mx-auto px-6 py-10">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-4">
                    Lihat apa kata pelanggan kami tentang Madani Motor
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <!-- Customer Info -->
                    <div
                        class="flex items-center pt-4 border-t border-gray-200"
                    >
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-[#BB0102] to-red-400 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3"
                        >
            ...
            <!-- CTA Section -->
            <div
                class="mt-12 bg-gradient-to-r from-[#BB0102] to-red-600 rounded-2xl p-8 text-white text-center"
            >
                <h2 class="text-2xl font-bold mb-3">
                    Sudah Beli Mobil di Madani Motor?
                </h2>
                <p class="mb-6 opacity-90">
                    Bagikan pengalaman Anda dengan calon pembeli lainnya!
                </p>
                <a
